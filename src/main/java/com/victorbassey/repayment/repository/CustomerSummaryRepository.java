...
public interface CustomerSummaryRepository extends JpaRepository<CustomerSummary, Long> {
    ...
    CustomerSummary findByCustomerIdAndSeasonId(Long customerId, Long seasonId);
    ...
    CustomerSummary findMostRecentCustomerSummary(@Param("customerId") Long customerId);
}
